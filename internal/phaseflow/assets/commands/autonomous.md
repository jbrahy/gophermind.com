...
<execution_context>
@~/.claude/phaseflow/workflows/autonomous.md
...
Project context, phase list, and state are resolved inside the workflow using init commands (`phase-sdk query init.milestone-op`, `phase-sdk query roadmap.analyze`). No upfront context loading needed.
</context>
