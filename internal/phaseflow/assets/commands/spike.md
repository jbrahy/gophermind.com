...
Spikes live in `.planning/spikes/` and integrate with PhaseFlow commit patterns, state tracking,
...
<execution_context>
@~/.claude/phaseflow/workflows/spike.md
@~/.claude/phaseflow/workflows/spike-wrap-up.md
