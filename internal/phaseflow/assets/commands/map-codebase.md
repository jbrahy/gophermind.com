...
<objective>
Analyze existing codebase using parallel phase-codebase-mapper agents to produce structured codebase documents.
...
<execution_context>
@~/.claude/phaseflow/workflows/map-codebase.md
</execution_context>
...
- Before /phase:new-project (brownfield codebases) - creates codebase map first
- After /phase:new-project (greenfield codebases) - updates codebase map as code evolves
...
3. Spawn 4 parallel phase-codebase-mapper agents:
...
7. Offer next steps (typically: /phase:new-project or /phase:plan-phase)
</process>
