...
<execution_context>
@~/.claude/phaseflow/workflows/spec-phase.md
@~/.claude/phaseflow/templates/spec.md
</execution_context>
...
- User knows they can now run /phase:discuss-phase which will load SPEC.md automatically
</success_criteria>
