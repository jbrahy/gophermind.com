...
**Orchestrator role:** Gather symptoms, spawn phase-debugger agent, handle checkpoints, spawn continuations.
...
Valid PhaseFlow subagent types (use exact names — do not fall back to 'general-purpose'):
- phase-debug-session-manager — manages debug checkpoint/continuation loop in isolated context
- phase-debugger — investigates bugs using scientific method
</available_agent_types>

<execution_context>
@~/.claude/phaseflow/workflows/debug.md
</execution_context>
