...
> AI design contract generated by `/phase:ai-integration-phase`. Consumed by `phase-planner` and `phase-eval-auditor`.
...
> Researched by `phase-domain-researcher`. Grounds the evaluation strategy in domain expert knowledge.
...
> Fetched from official docs by `phase-ai-researcher`. Distilled for this specific use case.
...
> Written by `phase-ai-researcher`. Cross-cutting patterns every developer building AI systems needs — independent of framework choice.
