...
For deep ecosystem research ("how do experts build this"), use `/phase:plan-phase --research-phase` which produces RESEARCH.md.
...
- Use `/phase:plan-phase --research-phase` for these
</guidelines>
