...
- [ ] **72. Tabular inspector.** CSV/JSON/Parquet schema + preview tool. Value: understand data files without dumping them.
...
- [ ] **80. Symbol index tool.** tree-sitter "find function/type X". Value: semantic navigation beyond grep.
