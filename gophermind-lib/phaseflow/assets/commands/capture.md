...
<objective>
Capture ideas, tasks, notes, and seeds to their appropriate destination in the PhaseFlow system.
...
<execution_context>
@~/.claude/phaseflow/workflows/add-todo.md
@~/.claude/phaseflow/workflows/note.md
@~/.claude/phaseflow/workflows/add-backlog.md
@~/.claude/phaseflow/workflows/plant-seed.md
@~/.claude/phaseflow/workflows/check-todos.md
