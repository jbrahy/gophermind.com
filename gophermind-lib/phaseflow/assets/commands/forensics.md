---
type: prompt
name: phase:forensics
description: Post-mortem investigation for failed PhaseFlow workflows — diagnoses what went wrong.
...
<objective>
Investigate what went wrong during a PhaseFlow workflow execution. Analyzes git history, `.planning/` artifacts, and file system state to detect anomalies and generate a structured diagnostic report.
...
<execution_context>
@~/.claude/phaseflow/workflows/forensics.md
</execution_context>
