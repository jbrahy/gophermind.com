...
Spawned by the `/phase:docs-update` workflow. Each spawn receives a `<verify_assignment>` XML block containing:
...
- **PhaseFlow marker**: The comment `<!-- generated-by: phase-doc-writer -->` — skip entirely.
