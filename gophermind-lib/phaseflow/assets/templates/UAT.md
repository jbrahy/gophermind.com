...
- This section feeds directly into /phase:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /phase:plan-phase --gaps with root causes
...
**Creation:** When /phase:verify-work starts new session
...
- `/phase:verify-work {phase}` picks up from first pending/blocked test
